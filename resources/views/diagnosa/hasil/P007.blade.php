...
@section('title', 'Kering Alur Sadap')

@section('content')

    <div id="content" class="flex flex-row max-sm:flex-col px-4 py-4">
        <img src="{{ asset('img/penyakit/P007.png') }}" class="my-2 w-[405px] h-[350px]" alt="CekKaret Logo" />
            ...
            <div
                ...
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Hasil Diagnosa :<span class="text-danger-600"> Penyakit Kering Alur Sadap</span> </h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                    &nbsp; &nbsp;Penyakit Kering Alur Sadap pada tanaman karet merupakan penyakit yang disebabkan oleh jamur
                    Fusarium oxysporum. Penyakit
                    ini dapat menyebabkan kerusakan pada batang pohon karet yang cukup serius. Gejala pertama dari penyakit
                    ini biasanya
                    terlihat pada batang pohon, di mana terdapat bercak-bercak coklat yang terlihat pada permukaan batang.
                    Bercak-bercak ini
                    kemudian akan membesar dan menyebabkan terjadinya retak-retak pada batang pohon. Selain itu, daun-daun
                    pohon juga dapat
                    terpengaruh oleh penyakit ini, di mana terdapat bercak-bercak coklat yang terlihat pada permukaan daun.
                    Jika tidak
