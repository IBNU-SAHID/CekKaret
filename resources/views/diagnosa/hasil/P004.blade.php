            ...
            <div
                ...
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Hasil Diagnosa :<span class="text-danger-600"> Penyakit Kanker Bercak </span> </h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                    &nbsp; &nbsp;Penyakit Kanker Bercak pada tanaman karet merupakan penyakit yang disebabkan oleh jamur
                    Nectria haematococca. Penyakit
