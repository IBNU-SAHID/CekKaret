...
@section('title', 'Nekrosis Kulit')

@section('content')

    <div id="content" class="flex flex-row max-sm:flex-col px-4 py-4">
        <img src="{{ asset('img/penyakit/P005.png') }}" class="my-2 w-[405px] h-[350px]" alt="CekKaret Logo" />
            ...
            <div
                ...
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Hasil Diagnosa :<span class="text-danger-600"> Penyakit Nekrosis Kulit</span> </h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                    &nbsp; &nbsp;Penyakit Nekrosis Kulit pada tanaman karet merupakan penyakit yang disebabkan oleh jamur
                    Hypoxylon spp. Penyakit ini
                    dapat menyebabkan kerusakan pada batang pohon karet yang cukup serius. Gejala pertama dari penyakit ini
                    biasanya
