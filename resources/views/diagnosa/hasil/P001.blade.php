        ...
        <div
            ...
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                   Hasil Diagnosa :<span class="text-danger-600"> Penyakit Akar Putih</span> </h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                &nbsp; &nbsp;Penyakit Jamur Akar Putih pada tanaman karet disebabkan oleh jamur Phytophthora palmivora.
                Penyakit ini dapat
                ...
                pada daun. Selain
                itu, akar-akar pohon juga dapat terpengaruh oleh penyakit ini, di mana terdapat bercak-bercak putih yang
                terlihat pada
