...
@section('title', 'Akar Putih')

@section('content')

<div id="content" class="flex flex-row max-sm:flex-col px-4 py-4">
    <img src="{{ asset('img/penyakit/P001.png') }}" class="my-2 w-[500px] h-[350px]" alt="CekKaret Logo" />

    <div class="pl-4">
        <div class="w-full p-6 bg-primary-200 border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    Penyakit Akar Putih</h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                &nbsp; &nbsp;Penyakit Jamur Akar Putih pada tanaman karet disebabkan oleh jamur Phytophthora palmivora. Penyakit ini dapat
                ...
                itu, akar-akar pohon juga dapat terpengaruh oleh penyakit ini, di mana terdapat bercak-bercak putih yang terlihat pada
