...
<div id="content" class="flex flex-row max-sm:flex-col px-4 py-4">
    <img src="{{ asset('img/penyakit/P007.png') }}" class="my-2 w-[500px] h-[350px]" alt="CekKaret Logo" />
        ...
        <div
            ...
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    Penyakit Kering Alur Sadap </h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                &nbsp; &nbsp;Penyakit Kering Alur Sadap pada tanaman karet merupakan penyakit yang disebabkan oleh jamur Fusarium oxysporum. Penyakit
